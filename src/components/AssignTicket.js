...
const AssignTicket = memo(({ onClose }) => {
  return (
    <div className="w-[776px] rounded-3xs bg-gray-0 overflow-hidden flex flex-col items-start justify-start p-2.5 box-border gap-[10px_0px] tracking-[normal] max-w-full max-h-full text-center text-12xl-3 text-black font-paragraph-d">
      ...
      <section className="self-stretch flex flex-col items-end justify-start py-2.5 px-0">
        <button className="cursor-pointer py-5 pr-[51px] pl-[49px] bg-steelblue-300 rounded-3xs overflow-hidden flex flex-row items-center justify-start border-[1px] border-solid border-gray-0 hover:bg-steelblue-100 hover:box-border hover:border-[1px] hover:border-solid hover:border-gainsboro-100">
          <b className="relative text-6xl font-paragraph-d text-gray-0 text-left mq450:text-xl">
            Done
          </b>
        </button>
      </section>
